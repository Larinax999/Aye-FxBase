-- maybe you can remove this if you want? IDK what this does
...
AddEventHandler('hostingSession', function()
    ...
    if currentHosting then
        ...
        table.insert(hostReleaseCallbacks,function()TriggerClientEvent('sessionHostResult',source,'free')end)
        return
    end
    ...
    SetTimeout(5000, function()
        if not currentHosting then return end
        currentHosting = nil
...
AddEventHandler('hostedSession', function()
    ...
    if currentHosting ~= source then -- TODO: drop client as they're clearly lying
